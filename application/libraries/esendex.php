...
class esendex extends EsendexFormPostUtilities
{
	...
	function send_message( $recipient, $body, $type = "text" )
	{
...
Description:	Push notifications for SMS received
Documentation: 	https://www.esendex.com/developertools/account/73c3d705-7e18-4674-a091-eeb8bd2bfd94/pushnotifications/gettingstarted

Author:   Murrion Software
*         paco@murrion.com
*         @pacobernabe
*
* Location: https://github.com/MurrionSoftware/essendex
*          
* Created:  07.01.2013 
* 
*/
	...
	function receive_message()
    {
    	$message = file_get_contents("php://input");
			/*$message ="<InboundMessage>
				 <Id>ea8f3b55-0649-4fb5-b1c8-20e4ca94b000</Id>
				 <MessageId>97488d44-625d-45b4-8f98-3684e172e000</MessageId>
				 <AccountId>73c3d705-7e18-4674-a091-eeb8bd2bfd00</AccountId>
				 <MessageText>This + is my @message text</MessageText>
				 <From>353876266600</From>
				 <To>353876266601</To>
				</InboundMessage>";*/
		
		$message = @simplexml_load_string($message);
		
		if ($message!==FALSE && property_exists($message, "MessageText") && property_exists($message,"From"))
		{
